...
{% hint style="info" %}
By default, LCD Games is grouped with Games & Watch system, you can ungroup it by following the [guide](../../../../en/navigation/system-view-and-game-view.md#grouped-systems).
{% endhint %}
