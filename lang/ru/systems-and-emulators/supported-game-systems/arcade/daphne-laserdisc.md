...
You can use use the [**VIEW OPTIONS**](../../../../en/navigation/view-options.md) to hide the `.zip` extension for the system by pressing **SELECT**
...
Navigate to [**VIEW CUSTOMIZATION**](../../../../en/navigation/view-options.md#view-options) and FILE EXTENSIONS
